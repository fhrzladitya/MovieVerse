  ...
  return (
    ...
    >
      ...
      >
        <button
          onClick={onClose}
          className="absolute right-4 top-4 z-20 h-11 w-11 rounded-full bg-red-500 text-white font-bold hover:bg-red-600"
        >
          ✕
        </button>
        ...
        <div className="relative w-full shrink-0">
          ...
          <div className="absolute bottom-4 left-4 right-4 text-white">
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              <span className="rounded-full bg-yellow-500 px-3 py-1 text-black font-bold text-sm">
                {text.rating} {movie.rating.average}
              </span>
              ...
              {movie.genres.map((genre) => (
                <span
                  key={genre}
                  className="rounded-full bg-red-500/80 px-3 py-1 text-xs"
                >
                  {getGenreLabel(genre)}
                </span>
              ))}
