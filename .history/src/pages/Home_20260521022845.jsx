...
function MovieModal({ movie, text, isDark, getGenreLabel, onClose }) {
  ...
  return (
    <div
      ...
      "
    >
      <div className="min-h-screen flex items-start justify-center p-3 md:p-6">
        <article
          onClick={(event) => event.stopPropagation()}
          className={`
            relative
        ...
        >
          ...
          <div className="p-5 md:p-8">
            <h3 className="mb-4 text-2xl font-bold">{text.movieSummary}</h3>
            ...
            <h3 className="mb-4 text-2xl font-bold">{text.officialTrailer}</h3>
