    ...
    <div className="fixed inset-0 z-[99999] bg-black">
      <div className="h-full overflow-y-auto">
        <button
          type="button"
          onClick={onClose}
          className="fixed right-4 top-4 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-red-500 text-xl font-bold text-white shadow-2xl transition hover:scale-110"
        >
          ✕
        </button>

        <div className="relative">
          <div className="relative h-[55vh] md:h-[85vh]">
            <img
            ...
            <div className="absolute bottom-0 left-0 w-full p-5 md:p-12">
              <h1 className="mb-4 text-4xl font-black text-white md:text-7xl">
                {movie.name}
              </h1>
          ...
          >
            ...
            >
              ...
              <div className="overflow-hidden rounded-3xl">
                <iframe
                  className="h-[220px] w-full sm:h-[350px] md:h-[500px] lg:h-[650px]"
